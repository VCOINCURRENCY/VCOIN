...
{
public:
    UniValue operator()(const libvcoin::InvalidEncoding &zaddr) const { return UniValue(UniValue::VOBJ); }

    UniValue operator()(const libvcoin::SproutPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
    ...
    UniValue operator()(const libvcoin::SaplingPaymentAddress &zaddr) const {
        UniValue obj(UniValue::VOBJ);
