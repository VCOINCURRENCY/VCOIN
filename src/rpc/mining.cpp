...
// Copyright (c) 2019 The Vcoin Core developers
...
//            "  \"coinbasevalue\" : n,               (numeric) maximum allowable input to coinbase transaction, including the generation award and transaction fees (in Satoshis)\n"
...
#else
        throw JSONRPCError(RPC_METHOD_NOT_FOUND, "vcoind compiled without wallet and -mineraddress not set");
#endif
    }
    ...
    if (IsSporkActive(SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT)
        ...
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Vcoin is downloading zelnode winners...");
