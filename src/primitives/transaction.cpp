...
{
    std::array<libvcoin::SproutNote, ZC_NUM_JS_OUTPUTS> notes;
...
public:
    ...
    bool operator()(const libvcoin::PHGRProof& proof) const
    {
    ...
    bool operator()(const libvcoin::GrothProof& proof) const
    {
