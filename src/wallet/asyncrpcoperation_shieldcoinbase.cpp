...
bool ShieldToAddress::operator()(const libvcoin::SproutPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libvcoin::SaplingPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libvcoin::InvalidEncoding& no) const {
    return false;
}
