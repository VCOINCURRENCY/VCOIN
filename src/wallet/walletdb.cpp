...
bool CWalletDB::WriteCryptedZKey(const libvcoin::SproutPaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libvcoin::SproutPaymentAddress& addr, const libvcoin::SproutSpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteSaplingZKey(const libvcoin::SaplingIncomingViewingKey &ivk,
...
bool CWalletDB::WriteSproutViewingKey(const libvcoin::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseSproutViewingKey(const libvcoin::SproutViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libvcoin::SproutPaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "sapzkey")
        {
            ...
            ssKey >> ivk;
            libvcoin::SaplingExtendedSpendingKey key;
            ssValue >> key;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libvcoin::ReceivingKey rk(rkValue);
        ...
        else if (strType == "csapzkey")
        {
            libvcoin::SaplingIncomingViewingKey ivk;
            ssKey >> ivk;
            libvcoin::SaplingExtendedFullViewingKey extfvk;
            ssValue >> extfvk;
            vector<unsigned char> vchCryptedSecret;
            ssValue >> vchCryptedSecret;
            wss.nCKeys++;
        ...
        {
            libvcoin::SaplingPaymentAddress addr;
            ssKey >> addr;
            libvcoin::SaplingIncomingViewingKey ivk;
            ssValue >> ivk;
