...
bool CBasicKeyStore::AddSproutSpendingKey(const libvcoin::SproutSpendingKey &sk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::AddSproutViewingKey(const libvcoin::SproutViewingKey &vk)
...
bool CBasicKeyStore::RemoveSproutViewingKey(const libvcoin::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::HaveSproutViewingKey(const libvcoin::SproutPaymentAddress &address) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSproutViewingKeys.count(address) > 0;
}

bool CBasicKeyStore::HaveSaplingFullViewingKey(const libvcoin::SaplingIncomingViewingKey &ivk) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSaplingFullViewingKeys.count(ivk) > 0;
}

bool CBasicKeyStore::HaveSaplingIncomingViewingKey(const libvcoin::SaplingPaymentAddress &addr) const
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::GetSaplingFullViewingKey(const libvcoin::SaplingIncomingViewingKey &ivk,
...
bool CBasicKeyStore::GetSaplingIncomingViewingKey(const libvcoin::SaplingPaymentAddress &addr,
...
bool CBasicKeyStore::GetSaplingExtendedSpendingKey(const libvcoin::SaplingPaymentAddress &addr, 
