...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Vcoin vcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vcoin transaction") + "\n" +
              "  vcoin-tx [options] -create [commands]   " + _("Create hex-encoded vcoin transaction") + "\n" +
              "\n";
