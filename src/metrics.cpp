...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your vcoin.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("vcoin-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a Vcoin node!") << std::endl;
    ...
    while (true) {
        ...
        if (isScreen) {
            ...
            std::cout << "[";
#ifdef WIN32
            std::cout << _("'vcoin-cli.exe stop' to exit");
#else
