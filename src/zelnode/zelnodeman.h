...
#ifndef VCCCASHNODES_VCCNODEMAN_H
#define VCCCASHNODES_VCCNODEMAN_H
...
#define VCCNODES_DUMP_SECONDS (15 * 60)
#define VCCNODES_DSEG_SECONDS (3 * 60 * 60)
...
#endif //VCCCASHNODES_VCCNODEMAN_H
