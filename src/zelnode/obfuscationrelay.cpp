...
//{
//    int nCount = std::min(zelnodeman.CountEnabled(MIN_PEER_PROTO_VERSION_VCCNODE), 20);
...
//{
//    Zelnode* pzn = zelnodeman.GetZelnodeByRank(nRank, nBlockHeight, MIN_PEER_PROTO_VERSION_VCCNODE);
//
//    if (pzn != NULL) {
