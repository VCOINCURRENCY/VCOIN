...
// VCC: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT) r = SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT_DEFAULT;
        if (nSporkID == SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT) r = SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT_DEFAULT;
...
{
    if (strName == "SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT") return SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT") return SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT;
...
{
    if (id == SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT) return "SPORK_1_VCCNODE_PAYMENT_ENFORCEMENT";
    if (id == SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT) return "SPORK_2_VCCNODE_UPGRADE_VOTE_ENFORCEMENT";
