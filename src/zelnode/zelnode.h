...
#ifndef VCCCASHNODES_VCCNODE_H
#define VCCCASHNODES_VCCNODE_H
...
#define VCCNODE_MIN_CONFIRMATIONS 15 // Zelnode collateral minimum confirmations
#define VCCNODE_MIN_ZNP_SECONDS (10 * 60) // Zelnode minimum ping time
#define VCCNODE_MIN_ZNB_SECONDS (5 * 60) // Zelnode minimum broadcast time
#define VCCNODE_PING_SECONDS (5 * 60)
#define VCCNODE_EXPIRATION_SECONDS (120 * 60)
#define VCCNODE_REMOVAL_SECONDS (130 * 60)
#define VCCNODE_CHECK_SECONDS 5

#define VCCNODE_BASIC_COLLATERAL 10000
#define VCCNODE_SUPER_COLLATERAL 25000
#define VCCNODE_BAMF_COLLATERAL 100000
...
public:
    ...
    bool IsEnabled()
    {
        return activeState == VCCNODE_ENABLED;
    }
    ...
    std::string Status()
    {
        ...
        if (activeState == Zelnode::VCCNODE_ENABLED) strStatus = "ENABLED";
        if (activeState == Zelnode::VCCNODE_PRE_ENABLED) strStatus = "PRE_ENABLED";
        if (activeState == Zelnode::VCCNODE_EXPIRED) strStatus = "EXPIRED";
        if (activeState == Zelnode::VCCNODE_VIN_SPENT) strStatus = "VIN_SPENT";
        if (activeState == Zelnode::VCCNODE_REMOVE) strStatus = "REMOVE";
