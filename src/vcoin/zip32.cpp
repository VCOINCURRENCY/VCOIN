...
boost::optional<std::pair<diversifier_index_t, libvcoin::SaplingPaymentAddress>>
    SaplingExtendedFullViewingKey::Address(diversifier_index_t j) const
{
    ...
    CSerializeData addr_bytes(libvcoin::SerializedSaplingPaymentAddressSize);
...
libvcoin::SaplingPaymentAddress SaplingExtendedFullViewingKey::DefaultAddress() const
{
...
libvcoin::SaplingPaymentAddress SaplingExtendedSpendingKey::DefaultAddress() const
{
...
bool IsValidSpendingKey(const libvcoin::SpendingKey& zkey) {
    return zkey.which() != 0;
}
