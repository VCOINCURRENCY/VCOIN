/*
See the Vcoin protocol specification for more information.
https://github.com/vcoin/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libvcoin::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libvcoin::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libvcoin::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
