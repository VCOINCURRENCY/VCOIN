...
} // end namespace `libvcoin`


typedef libvcoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libvcoin::SHA256Compress> SproutMerkleTree;
typedef libvcoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvcoin::SHA256Compress> SproutTestingMerkleTree;

typedef libvcoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libvcoin::SHA256Compress> SproutWitness;
typedef libvcoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvcoin::SHA256Compress> SproutTestingWitness;

typedef libvcoin::IncrementalMerkleTree<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libvcoin::PedersenHash> SaplingMerkleTree;
typedef libvcoin::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvcoin::PedersenHash> SaplingTestingMerkleTree;

typedef libvcoin::IncrementalWitness<SAPLING_INCREMENTAL_MERKLE_TREE_DEPTH, libvcoin::PedersenHash> SaplingWitness;
typedef libvcoin::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvcoin::PedersenHash> SaplingTestingWitness;
