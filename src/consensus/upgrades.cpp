...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
    {
        /*.nBranchId =*/ 0,
        /*.strName =*/ "Base",
        /*.strInfo =*/ "The Vcoin network at launch",
    },
    {
    ...
    },
     {
        ...
        /*.strName =*/ "LWMA",
        /*.strInfo =*/ "Vcoin upgraded to LWMA difficulty algorithm",
    },
     {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Equihash 144/5",
        /*.strInfo =*/ "Vcoin PoW Change to Equihash 144/5",
    },	
    {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Acadia",
        /*.strInfo =*/ "The Vcoin Acadia Update",
    },
    {
        /*.nBranchId =*/ 0x76b809bb,
        /*.strName =*/ "Kamiooka",
