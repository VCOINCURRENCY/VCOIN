...
# This script tests that the package mirror at https://zel.cash/depends-sources/
# contains all of the packages required to build this version of Vcoin.
#
# This script assumes you've just built Vcoin, and that as a result of that
...
MIRROR_URL_DIR="https://zel.cash/depends-sources/"
