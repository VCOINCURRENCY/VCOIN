...
router", implementing the vcoin wire protocol and relay, making
...
The ZeroMQ feature in Vcoin requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ vcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/vcoind.tx.raw
...
From the perspective of vcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into vcoind directly. Furthermore, no information is
...
using. Vcoind appends an up-counting sequence number to each
